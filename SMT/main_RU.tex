...
\input{SMT/de_bruijn_SMT/main_RU}
\input{SMT/zebra_RU}
\input{SMT/pe31_RU}
\input{SMT/LCG/1_RU}
%\input{SMT/LCG/2_RU}
...
%\input{SMT/rubik2/failed/main_RU} % TBT
%\input{SMT/rubik3/one_face/main_RU} % TBT
%\input{SMT/cribbage_RU} % TBT
%\input{SMT/menage_RU} % TBT
%\input{SMT/sorting_network/main_RU}
%\input{SMT/stable_marriage/main_RU}
%\input{SMT/regexp/main_EN}
%\input{SMT/tsort/main_RU}
%\input{SMT/TSP/main_RU}
%\input{SMT/cross/main_RU}
%\input{SMT/TAOCP_7_1_3_exercise_15/main_RU}
%\input{SMT/Android/main_RU}
%\input{SMT/keypad/main_RU}
%\input{SMT/knight_tour/main_RU}
%\input{SMT/Hilbert_10/main_RU}
