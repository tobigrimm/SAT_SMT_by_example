...
( The source code: \url{https://github.com/DennisYurichev/SAT_SMT_article/blob/master/SMT/XOR/1.py} )

Let's try it on a small 350-bytes file\footnote{\url{https://github.com/DennisYurichev/SAT_SMT_article/blob/master/SMT/XOR/cipher1.txt}}:
...
( The source code: \url{https://github.com/DennisYurichev/SAT_SMT_article/blob/master/SMT/XOR/2.py} )
...
( The source code: \url{https://github.com/DennisYurichev/SAT_SMT_article/blob/master/SMT/XOR/3.py} )
...
The files: \url{https://github.com/DennisYurichev/SAT_SMT_article/tree/master/SMT/XOR}.
