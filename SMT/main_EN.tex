...
\input{SMT/de_bruijn_SMT/main_EN}
\input{SMT/zebra_EN}
\input{SMT/pe31_EN}
\input{SMT/pipe_EN}
...
\input{SMT/TAOCP_7_1_3_exercise_15/main_EN}
\input{SMT/Android/main_EN}
\input{SMT/keypad/main_EN}
\input{SMT/knight_tour/main_EN}
\input{SMT/Hilbert_10/main_EN}
