...
% dunno why
%What is also weird is that if to replace all OR operations in my piece of source code to addition ones, it stopping working, I don't know why.
%Maybe I did something wrong? Or hit some bug related to handling summing operation for bit vector \textit{sort}?
