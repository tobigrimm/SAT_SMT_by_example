...
% subsections:
\input{SAT/8queens/main_RU}
\input{SAT/sudoku/main_RU}
\input{SAT/zebra/main_RU}
\input{SAT/minesweeper/main_RU}
\input{SAT/GoL/main_RU}
\input{SAT/backtrack/main_RU}
\input{SAT/factor/main_RU}
\input{SAT/XOR/main_RU}
\input{SAT/rubik2/main_RU}
