...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.6]{MK85/adder/400px-Full-adder_logic_diagram.svg.png}}
\end{figure}
...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.6]{MK85/adder/500px-4-bit_ripple_carry_adder.svg.png}}
\end{figure}
...
( \url{https://github.com/DennisYurichev/MK85/blob/master/MK85.c} )
...
\lstinputlisting{MK85/adder/tmp.cnf}

Filter out comments:

\lstinputlisting{MK85/adder/tmp.cnf.comments}
