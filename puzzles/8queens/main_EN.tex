...
Here is how I can generate clauses for the function using \emph{itertools} module from Python,
...
\TT{AtMost1()} function enumerates all possible pairs using \emph{itertools} function
\emph{combinations()}.
