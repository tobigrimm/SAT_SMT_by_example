...
\input{puzzles/sudoku/1/main_EN}
\input{puzzles/sudoku/GT/main_EN}
\input{puzzles/sudoku/killer/main_EN}
\input{puzzles/sudoku/KLEE/main_EN}
\input{puzzles/sudoku/SAT/main_EN}
