...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.6]{MaxSxT/assign_problem/1.png}}
\end{figure}
...
\lstinputlisting[style=custompy]{MaxSxT/assign_problem/1.py}
...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.6]{MaxSxT/assign_problem/2.png}}
\end{figure}
...
\lstinputlisting[style=customsmt]{MaxSxT/assign_problem/assign_problem.smt}

\lstinputlisting[caption=The result]{MaxSxT/assign_problem/assign_problem.correct}
