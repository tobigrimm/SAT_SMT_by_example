...
\RU{\newcommand{\TITLE}{Краткое введение в SAT/SMT-солверы и символьное исполнение}}
\EN{\newcommand{\AUTHOR}{Dennis Yurichev \TT{<dennis(a)yurichev.com>}}}
\RU{\newcommand{\AUTHOR}{Денис Юричев \TT{<dennis(a)yurichev.com>}}}
...
\author{\AUTHOR}
\title{\TITLE}
\EN{\date{December 2015 -- May 2017}}
\RU{\date{Декабрь 2015 -- май 2017}}
