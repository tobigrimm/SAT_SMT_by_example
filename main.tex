...
\EN{
\input{intro_EN}
\input{equations/main_EN}
\input{SMT/main_EN}
\input{puzzles/main_EN}
\input{knapsack/main_EN}
\input{SGP/main_EN}
\input{latin/main_EN}
\input{CRC/main_EN}
\input{MaxSMT/main_EN}
\input{pgm_synth/main_EN}
\input{toy_decompiler/main_EN}
\input{symbolic/main_EN}
\input{KLEE/main_EN}
\input{crypto/main_EN}
\input{SAT/main_EN}
\input{MaxSAT/main_EN}
\input{reading_EN}
}
\RU{
\input{intro_RU}
\input{equations/main_RU}
\input{SMT/main_RU}
\input{puzzles/main_RU}
%\input{knapsack/main_RU}
%\input{SGP/main_RU}
%\input{latin/main_RU}
%\input{CRC/main_RU}
\input{MaxSMT/main_RU}
\input{pgm_synth/main_RU}
\input{toy_decompiler/main_RU}
\input{symbolic/main_RU}
\input{KLEE/main_RU}
\input{crypto/main_RU}
\input{SAT/main_RU}
\input{MaxSAT/main_RU}
\input{reading_RU}
}
