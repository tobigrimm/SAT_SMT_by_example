...
Indeed, $log_2{26^{14}}=65.8$ % FIXME tilde
which is close to 64 bits.
In other words, one need 14 latin characters to encode 64 bits. % FIXME tilde
...
It works, because 6 Latin characters in \textit{A..Z} limits contain ~28.2 bits: % tilde
