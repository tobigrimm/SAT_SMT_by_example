\subsection{\ac{SMT}-solvers}

\subsubsection{School-level system of equations}
...
\subsubsection{Another school-level system of equations}
\label{eq2_SMT}
...
\subsubsection{Why variables are declared using declare-fun?}

They mean this is nullary function, only returning a constant, nothing else.

\subsubsection{Connection between \ac{SAT} and \ac{SMT} solvers}
