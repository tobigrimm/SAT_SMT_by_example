...
In order to execute the block, we should solve this equation: $((\frac{input}{86400}+4) mod 7)==5$.
...
Now we have two blocks: for the first we should solve this equation: $((\frac{input}{86400}+4) mod 7)==5$.
But for the second we should solve inverted equation: $((\frac{input}{86400}+4) mod 7)!=5$.
...
The files used in this part: URL ... /symbolic
