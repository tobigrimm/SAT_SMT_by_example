\section{TAOCP 7.1.3 Exercise 203, MMIX MOR instruction and program synthesis by sketching}
...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.6]{pgm_synth/TAOCP_713_203/203a.png}}
\caption{Screenshot from TAOCP book}
\end{figure}
