...
There is also implementation in pure C\footnote{\url{https://github.com/DennisYurichev/SAT_SMT_by_example/tree/master/toy_decompiler/files/C}}, node is represented using structure.
...
\url{https://github.com/DennisYurichev/SAT_SMT_by_example/tree/master/toy_decompiler/files/Racket}} (like \textit{'OP\_DIV}, etc).
...
Python version and tests: \url{https://github.com/DennisYurichev/SAT_SMT_by_example/tree/master/toy_decompiler/files}.
